...
api.post('/address/', [md_auth.ensureAuth, md_wh.createWarehouse], AddressController.saveOne)
api.put('/address/:id', md_auth.ensureAuth, AddressController.updateOne)
api.delete('/address/:id', md_auth.ensureAuth, AddressController.deleteOne)
