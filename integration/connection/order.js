    ...
    const p = new Promise(function(resolve, reject) {
        ...
        soap.createClient(createOrderWsdl, function(err, client) {
            ...
            const args = {
                ...
                TotalP1: 0,
                Producto2: order.items[1].productType.code,
                CantidadProducto2: order.items[1].quantity,
                ValorUnitarioP2: order.items[1].price,
                ValorNegociableP2: order.items[1].negotiable,
                TotalP2: 0,
                Producto3: order.items[2].productType.code,
                CantidadProducto3: order.items[2].quantity,
                ValorUnitarioP3: order.items[2].price,
                ValorNegociableP3: order.items[3].negotiable,
                TotalP3: 0,
                Producto4: order.items[3].productType.code,
                CantidadProducto4: order.items[3].quantity,
                ValorUnitarioP4: order.items[3].price,
                ValorNegociableP4: order.items[3].negotiable,
                TotalP4: 0,
                Importe: 0,
